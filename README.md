...
Hands-on FPGA projects demonstrating hardware–software co-design using Vivado, Vitis, Vitis HLS, AXI, and DMA.
...
Complete data flow: UART → DDR → DMA → AXI-Stream IP → DMA → DDR → UART
